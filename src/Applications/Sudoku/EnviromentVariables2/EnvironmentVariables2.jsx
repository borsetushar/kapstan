            ...
            <Box key={index} sx={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
              <TextField
                ...
                onChange={(e) => {
                  ...
                  localStorage.setItem('environmentVariables2', JSON.stringify(updatedVariables));
                }}
              />
...
export default EnvironmentVariables2;
