...
import systemMetricsData from './systemMetricsdata2'; // Importing system metrics data from external file

const SystemMetricscard2 = () => {
...
export default SystemMetricscard2;
