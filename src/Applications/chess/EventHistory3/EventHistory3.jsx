...
import eventHistorydata2 from './eventHistorydata3'; // Importing eventData from external file
    ...
    <Box sx={{ border: '1px solid #ccc', borderRadius: '8px', marginBottom: '20px', padding: '20px', backgroundColor:'white' }}>
      ...
      <TableContainer component={Paper}>
        <Table>
          ...
          <TableBody>
            {eventHistorydata2.map((eventItem, index) => (
              <TableRow key={index}>
                <TableCell>
