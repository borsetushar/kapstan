...
import systemMetricsData from './systemMetricsdata3'; // Importing system metrics data from external file

const SystemMetricscard3 = () => {
...
export default SystemMetricscard3;
